...
**Residual risk after Slice 1:** The broader SEC-01 finding remains open for the other upload transports and admin-only helper methods that still rely on ambient elevation or lack equivalent object and destination authorization, especially `pwg.images.addChunk`, chunk/check helpers, and upload-completion helpers.
