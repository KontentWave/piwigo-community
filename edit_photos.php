...
if (isset($_POST['submit']))
{
  ...
  {
    $available_levels = array_merge(array(16), $conf['available_permission_levels']);

    if (!isset($_POST['level']) || !in_array((int) $_POST['level'], $available_levels))
    {
      $page['errors'][] = l10n('Invalid level');
    }
    else
    {
      $datas = array();
...
$template->assign(array(
  ...
  'tag_list' => $tag_list,
  'level_options' => array(16 => l10n('Level 16')) + get_privacy_level_options(),
